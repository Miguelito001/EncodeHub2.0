...
export const tools: Tool[] = [
  ...
  },
  {
    ...
    label: "Timestamp",
    description: "Converta timestamps Unix (segundos ou ms) em datas legíveis e vice-versa",
    icon: Clock4,
    color: "text-amber-400",
    category: "Conversão",
    keywords: ["epoch", "unix", "date", "milissegundos", "segundos"],
  },
  {
    href: "/cores",
    title: "Conversor de Cor",
    label: "Cores",
    description: "Converta entre HEX, RGB, HSL e CMYK com pré-visualização",
    icon: Palette,
    color: "text-pink-400",
    category: "Frontend",
    keywords: ["color", "hex", "rgb", "hsl", "cmyk", "cor"],
  },
  {
    href: "/url-parser",
    title: "Parser de URL",
    label: "URL Parser",
    description: "Quebre uma URL em protocolo, host, path e parâmetros de query",
    icon: Link2,
    color: "text-yellow-400",
    category: "Rede",
    keywords: ["query", "params", "querystring", "parse", "url"],
  },
  {
    href: "/extrator",
    title: "Extrator de Dados",
    label: "Extrator",
    description: "Extraia e-mails, URLs, IPs, CPFs, telefones e datas de um texto",
    icon: ScanText,
    color: "text-cyan-400",
    category: "Texto",
    keywords: ["regex", "email", "ip", "cpf", "extract", "scrape"],
  },
  {
    href: "/markdown",
    title: "Markdown Editor",
    label: "Markdown",
    description: "Escreva Markdown com pré-visualização renderizada ao vivo",
    icon: FileText,
    color: "text-sky-400",
    category: "Texto",
    keywords: ["md", "preview", "readme", "editor"],
  },
  {
    href: "/mock-data",
    title: "Gerador de Mock Data",
    label: "Mock Data",
    description: "Defina campos e gere dados falsos em JSON ou CSV para testes",
    icon: Database,
    color: "text-lime-400",
    category: "Dev",
    keywords: ["fake", "faker", "seed", "test", "json", "csv"],
  },
];
